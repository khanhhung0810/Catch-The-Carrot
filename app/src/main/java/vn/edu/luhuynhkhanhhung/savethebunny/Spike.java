...
public class Spike {
    ...
    public Spike(Context context){
        spike[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.carrot1);
        spike[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.carrot2);
        spike[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.carrot0);
        random = new Random();
        resetPositon();
